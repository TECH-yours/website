...
(function (factory) {
    ...
    var BLANKRE = /^\s*$/g,
        ...
        renderATitle = function (node, t, tree) {
            var a = node.hasClass("jstree-anchor") ? node : node.children("[class~='jstree-anchor']"), title,
...
//public function. validate searchObject keys, set columnSearch flag, calls jstree search and reset columnSearch flag
        ...
        this.bind = function () {
            ...
            this.element
                ...
                .on("ready.jstree", $.proxy(function (e, data) {
                    ...
                    var anchorHeight = this.element.find("[class~='jstree-anchor']:first").outerHeight() + 6, q,
        ...
        this._reattachColumns = function (id) {
            ...
            if (this._domManipulation.id === id) {
                ...
                if (this._domManipulation.oldActiveElement !== document.activeElement) {
                    $(this._domManipulation.oldActiveElement).focus();
                }
        ...
        this._hide_grid = function (node) {
            ...
            this._detachColumns(node.id);
            var children = node.children ? node.children : [], cols = this._gridSettings.columns || [],
